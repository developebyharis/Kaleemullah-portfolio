...
const useFluidCursor = () => {
  ...
  let config = {
    ...
    DENSITY_DISSIPATION: 1.0, // lower = fluid stays longer (slower fade)
    VELOCITY_DISSIPATION: 1.2, // lower = smoother motion
    PRESSURE: 0.1,
    PRESSURE_ITERATIONS: 20,
    CURL: 3,
    SPLAT_RADIUS: 0.25, // slightly bigger spread
    SPLAT_FORCE: 800, // MUCH lower force (was 6000)
    SHADING: true,
    COLOR_UPDATE_SPEED: 5.0, // slower color transitions
    PAUSED: false,
